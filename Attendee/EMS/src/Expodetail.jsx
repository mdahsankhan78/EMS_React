...
// console.log(id);
    ...
    const handleSubmit = (e) => {
      e.preventDefault()
        ...
        axios.post('http://localhost:3500/register/expo/attendee', register)
          .then(response => {
            console.log(response);
            setMessage('Registerred Successfully'); // Set success message
            setTimeout(() => {
  ...
  <div className="intro-container wow fadeIn" style={{marginTop: '120px'}}>
   ...
   <div className="col-7">
    ...
    <a onClick={handleSubmit} className="about-btn scrollto">Register</a>
