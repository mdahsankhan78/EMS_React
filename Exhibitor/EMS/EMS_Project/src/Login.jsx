...
const Login = () => {
    ...
    const handleSave = (e) => {
        ...
        axios.post('http://localhost:3500/login/exhibitor', data)
        .then(x => {
          console.log(x);
          ...
          <div className="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 ">
            <div className="rounded p-4 p-sm-5 my-4 mx-3" style={{ background: 'rgba(6, 12, 34, 0.98)' }}>
              ...
              <div className="form-floating mb-3">
                <input name='useremail' onChange={handleInput} type="email" className="form-control bg-white" id="floatingInput" placeholder="name@example.com" />
